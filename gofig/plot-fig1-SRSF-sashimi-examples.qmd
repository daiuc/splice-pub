...
knitr::include_graphics("SRSF9_tracks.svg")
```
...
lf_num = fread(
    "../code/results/pheno/noisy/Geuvadis/EUR/wConst_perind_numers.constcounts.noise_by_intron.gz",
    sep=" ",
)
...
plotGenes = paste0("SRSF", c(11, 10, 4, 3, 7, 9, 1, 6))
...
# plotGene=SRSF4
# plotRange="chr1:19140000-19185000"
# pyGenomeTracks --tracks plot_config.ini \
#   --title "$plotGene $plotRange" \
#   --region $plotRange \
#   --width 40 \
...
plotGene=SRSF9
plotRange="chr12:120455000-120470000"
pyGenomeTracks --tracks plot_config.ini \
  --title "$plotGene $plotRange" \
  --region $plotRange \
  --width 40 \
