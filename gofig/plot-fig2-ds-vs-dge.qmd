...
```{r}
i = which(contrast_list == 'Brain-Cortex_v_Kidney-Cortex')
res = read_contrast(rds_list[i], contrast_list[i], plot = TRUE)
ggsave("plot-fig2-brain-cortex-v-kidney-cortex.svg", res$gg, width = 7, height = 5)
```


```{r}
#| label: fig-brain-cortex-v-kidney-cortex
#| eval: true
#| include: true
#| fig-cap: "Correlation of DS and DGE: Brain-Cortex vs. Kidney-Cortex"
#| out-width: 80%

knitr::include_graphics("plot-fig2-brain-cortex-v-kidney-cortex.svg")
```
