...
ad.tally2 = left_join(
  tissue_code[, .(tissue = tissue_code)],
  dt[, .(N_GES = uniqueN(gene_id)), by = tissue]
  )
ad.tally2 = left_join(
  ad.tally2,
  dt2[, .(N_GE = uniqueN(gene_id)), by = tissue]
  )
ad.tally2 = left_join(
  ad.tally2,
  dt3[, .(N_GS = uniqueN(gene_id)), by = tissue]
  )
...
#| out-width: 100%
#| label: fig-AD-coloc2
#| fig-cap: AD GWAS coloc with eQTL, sQTL - Number of genes
ad.tally2 %>% 
  melt(id.vars = "tissue", variable.name = "type", value.name = "N") %>%
  ggplot() + geom_point(aes(x = tissue, y = N, color = type)) +
    labs(x = NULL, y = "Number of coloc genes", color = NULL,
         caption = glue("{N_hit_loci} hit GWAS loci")) +
    theme(axis.text.x = element_text(angle = 90, hjust = 1)) 
...
#| out-width: 100%
#| label: fig-PD-coloc2
#| fig-cap: PD GWAS coloc with eQTL, sQTL - Number of genes
ad.tally2 %>% 
  melt(id.vars = "tissue", variable.name = "type", value.name = "N") %>%
  ggplot() + geom_point(aes(x = tissue, y = N, color = type)) +
    labs(x = NULL, y = "Number of coloc genes", color = NULL,
...
#| out-width: 100%
#| label: fig-HT-coloc2
#| fig-cap: HT GWAS coloc with eQTL, sQTL - Number of genes
ad.tally2 %>% 
  melt(id.vars = "tissue", variable.name = "type", value.name = "N") %>%
  ggplot() + geom_point(aes(x = tissue, y = N, color = type)) +
    labs(x = NULL, y = "Number of coloc genes", color = NULL,
...
#| fig-width: 10
#| out-width: 100%
#| label: fig-T2D-coloc2
#| fig-cap: T2D GWAS coloc with eQTL, sQTL - Number of genes
ad.tally2 %>% 
  melt(id.vars = "tissue", variable.name = "type", value.name = "N") %>%
  ggplot() + geom_point(aes(x = tissue, y = N, color = type)) +
    labs(x = NULL, y = "Number of coloc genes", color = NULL,
...
# coloc result data example

Relable unproductive s. productive sQTLs.
